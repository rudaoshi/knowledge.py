...
from knowledge.machine.core.gradient_optimizable import GradientOptimizable
...
class MultiLayerPerception(GradientOptimizable):
    ...
    def set_parameter(self, param_vec):
        ...
        self.logLayer.W = param_vec[start_idx : start_idx + W.size].reshape(W.shape)
        start_idx += W.size
        self.logLayer.b = param_vec[start_idx : start_idx + b.size].reshape(b.shape)
        start_idx += b.size
